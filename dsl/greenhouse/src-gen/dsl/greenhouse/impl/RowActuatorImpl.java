 ...
 *   <li>{@link dsl.greenhouse.impl.RowActuatorImpl#getSafeState <em>Safe State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RowActuatorImpl extends RowElementImpl implements RowActuator
{
  ...
  public SettingAction getSafeState()
  {
    if (safeState != null && safeState.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, GreenhousePackage.ROW_ACTUATOR__SAFE_STATE, oldSafeState, safeState));
      }
    }
    return safeState;
  }
  ...
  public void setSafeState(SettingAction newSafeState)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GreenhousePackage.ROW_ACTUATOR__SAFE_STATE, oldSafeState, safeState));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case GreenhousePackage.ROW_ACTUATOR__ACTION:
        return getAction();
      case GreenhousePackage.ROW_ACTUATOR__SAFE_STATE:
